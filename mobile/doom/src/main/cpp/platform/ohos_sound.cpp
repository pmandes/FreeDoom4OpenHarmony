...
// Communication via per-channel atomics — zero locks in the audio path.
...
// i_sound.c binds these variables to the config (normally defined by i_sdlsound.c,
...
// Cache lazily on the first StartSound — precaching not needed.
