...
// iwadPath: absolute path to an imported IWAD; empty/nonexistent
// -> fall back to the bundled freedoom1.wad copied from rawfile.
...
// pushChar(code) — raw ASCII character (down+up) for entering text in the engine
